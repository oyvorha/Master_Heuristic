...
class Vehicle:
    ...
    def __init__(self, init_battery_load, init_battery_bikes, init_flat_bikes, cap=20):
    ...
    def available_capacity(self):
        return max(0, self.capacity - (self.current_flat_bikes + self.current_battery_bikes))
